   ...
   <!-- page content -->
                    ...
                    <form id="demo-form2" action="../netting/islem.php" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" name="kullanici_adsoyad" required="required" class="form-control col-md-7 col-xs-12" >
                        </div>
                      </div>
        ...
        <footer>
          <div  class="pull-center">
             Made BY ME$ Babafiyatlar <a target="_blank" href="https://babafiyatlar.com">ME$</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
