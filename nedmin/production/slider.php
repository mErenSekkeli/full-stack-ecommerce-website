        ...
        <div class="right_col" role="main">
          <div class="">
                  ...
                  <div class="x_title">
                    ...
                    <br>
                    <div align="right">
                    <button class="btn btn-primary"><a href="slider-ekle.php" style="color:white;">Ekle</a></button>
                    </div>
...
while ( $slidercek=$slidersor->fetch(PDO::FETCH_ASSOC)) { $say++;?>
                        ...
                        <tr>
                          <td width="150" ><img width="170" src="../../<?php echo $slidercek['slider_resimyol']; ?>"></td>
                         ...
                         <?php }else { ?>
                          ...
                          <td><center><a href="../netting/islem.php?slider_id=<?php echo $slidercek['slider_id'] ?>&slider_sil=ok"><button class="btn btn-danger btn-xs">Sil</button></a></center></td>
                          </tr>
      ...
      $(document).ready(function() {
        function initToolbarBootstrapBindings() {
          var fonts = ['Serif', 'Sans', 'Arial', 'Arial Black', 'Courier',
            ...
            fontTarget = $('[title=Font]').siblings('.dropdown-slider');
          ...
          $('.dropdown-slider input').click(function() {
              return false;
            })
            .change(function() {
              $(this).parent('.dropdown-slider').siblings('.dropdown-toggle').dropdown('toggle');
            })
