             ...
             <div align="left" class="col-md-6">
              ...
              <input type="hidden" name="urun_id" value="<?php echo $_GET['urun_id']; ?>">
                ...
                <div align="right" class="col-md-6">
                   <a class="btn btn-success" href="urunfoto-duzenle.php?urun_id=<?php echo $_GET['urun_id'];?>"><i class="fa fa-plus" aria-hidden="true"></i>Resim Sırası</a>
                  ...
                  <div class="col-md-55">
                   <label>
                    <div class="image view view-first">
                      <img style="width: 180px; height: 300px; display: block;" src="../../<?php echo $urunfotocek['urunfoto_yol']; ?>" alt="image" />
                      <div class="mask">
