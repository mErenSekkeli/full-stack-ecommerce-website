  ...
  <script src="https://cdn.ckeditor.com/4.7.1/standard/ckeditor.js"></script>
      ...
      <!-- page content -->
        <div class="right_col" role="main">
                   ...
                   <?php                   
                    if ($_GET['menu_sil']=="ok") {
                      ?><b style="color:green;">Menü Silindi.</b>                        
                    ...
                    <div class="x_panel">
                  <div class="x_title">
                    <h2>Menü Listesi <small>Menüler</small></h2>
                    <br>
                    <div align="right">
                    <button class="btn btn-primary"><a href="menu-ekle.php" style="color:white;">Ekle</a></button>
                    </div>
...
while ( $menucek=$menusor->fetch(PDO::FETCH_ASSOC)) { $say++;?>
                        ...
                        <tr>
                         ...
                         <?php }else { ?>
                          ...
                          <td><center><a href="../netting/islem.php?menu_id=<?php echo $menucek['menu_id'] ?>&menu_sil=ok"><button class="btn btn-danger btn-xs">Sil</button></a></center></td>
                          </tr>
