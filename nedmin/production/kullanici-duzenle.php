                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" action="../netting/islem.php" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" readonly="" id="first-name" name="kullanici_id"  class="form-control col-md-7 col-xs-12" value="<?php echo $_GET['kullanici_id']; ?>">
                        </div>
                      </div> 
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" name="kullanici_mail" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $kullanicicek['kullanici_mail']; ?>">
                        </div>
                      </div>
                      <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="heard" class="form-control"  value="<?php echo $kullanicicek['kullanici_durum']; ?>" name="kullanici_durum">
                      ...
                      <div class="form-group">
                        <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" name="kullaniciduzenlekaydet" class="btn btn-success">Güncelle</button>
                        </div>
                      </div>
