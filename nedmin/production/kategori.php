          ...
          <div class="">
                   ...
                   <?php                   
                    if ($_GET['kategori_sil']=="ok") {
                      ?><b style="color:green;">Kategori Silindi.</b>                        
                    <?php } elseif ($_GET['kategori_sil']=="no") {
                     ?><b style="color:red;">İşlem Başarısız.</b><?php
                    } ?></small>
                    ...
                    <div class="x_panel">
                  <div class="x_title">
                    <h2>Kategori Listesi <small>Kategoriler</small></h2>
                    <br>
                    <div align="right">
                    <button class="btn btn-primary"><a href="kategori-ekle.php" style="color:white;">Ekle</a></button>
                    </div>
...
while ( $kategoricek=$kategorisor->fetch(PDO::FETCH_ASSOC)) { $say++;?>
                        ...
                        <tr>
                          ...
                          <td width="100" ><img width="100" src="../../dimg/<?php echo $kategoricek['kategori_icon']; ?>"></td>
                         ...
                         <?php }else { ?>
                          ...
                          <td><center><a href="../netting/islem.php?kategori_id=<?php echo $kategoricek['kategori_id'] ?>&kategori_sil=ok"><button class="btn btn-danger btn-xs">Sil</button></a></center></td>
                          </tr>
